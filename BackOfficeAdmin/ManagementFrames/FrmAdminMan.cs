...
{
    public partial class FrmAdminMan : Form
    {
        ...
        private void btnDelete_Click(object sender, System.EventArgs e)
        {
            try
            {
                ...
                if (objUser.ErrorMessage == null)
                {
                    ...
                    {
                        MessageBox.Show("No se pudo eliminar: el usuario ingresado es un cliente", "Mensaje de error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
                else
                {
